    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.html">EasyBuy<sup>beta</sup></a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h3>It seems like we encountered an Exception.Please check that you provided a valid amazon URL and Try again</h3>
            ...
            <div class="row">
             ...
             <div class="row">
                    <div class="container text-center">
                         <input type="submit" class="btn-info btn btn-lg" onclick="loader()">
                    </div>
                </div>
            </form>
        </div>
